...
$langId = defined('LANGUAGE_ID') && LANGUAGE_ID ? LANGUAGE_ID : 'ru';
...
if(AccessController::isViewSettings() || AccessController::isViewRight()){
    ...
    if(AccessController::isViewSettings()){
        $level2[] = [
            "text" => Loc::getMessage('AWZ_PULL_MENU_NAME_SETT_1'),
            "url" => "settings.php?lang=".$langId.'&mid='.$module_id.'&mid_menu=1'
        ];
    }
    if(AccessController::isViewRight()){
        $level2[] = [
            "text" => Loc::getMessage('AWZ_PULL_MENU_NAME_SETT_2'),
            "url" => "javascript:BX.SidePanel.Instance.open('/bitrix/admin/settings.php?mid=".$module_id."&lang=".LANGUAGE_ID."&mid_menu=1');"
        ];
    }
    $items[] = [
        "text" => Loc::getMessage('AWZ_PULL_MENU_NAME_SETT'),
...
$aMenu[] = array(
    ...
    "sort" => 100,
    "module_id" => $module_id,
    "text" => Loc::getMessage('AWZ_PULL_MENU_NAME_AWZ_PULL'),
    "title" => Loc::getMessage('AWZ_PULL_MENU_NAME_AWZ_PULL'),
